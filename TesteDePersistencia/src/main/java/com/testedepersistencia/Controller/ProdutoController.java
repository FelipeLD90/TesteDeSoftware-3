package com.testedepersistencia.Controller;

import com.fasterxml.jackson.annotation.JsonView;

import com.testedepersistencia.Produto.Produto;
import com.testedepersistencia.Produto.ProdutoRepository;
...
public class ProdutoController {
    ...
    private ResponseEntity editar(@RequestBody Produto produto){
        produtoRepository.salvar(produto);
        return ResponseEntity.status(200).body(produto.getId());
    }
